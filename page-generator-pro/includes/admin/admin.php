...
class Page_Generator_Pro_Admin {
	...
	public function admin_scripts_css() {
		...
		wp_register_script( $this->base->plugin->name . '-generate-browser', 'https://www.wpzinc.com/wp-content/plugins/page-generator-pro-api/assets/js/min/generate-browser-min-4.3.7.js', array( 'jquery' ), $this->base->plugin->version, true );
